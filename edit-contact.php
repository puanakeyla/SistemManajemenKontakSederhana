        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-t-2xl shadow-2xl overflow-hidden slide-in">
            <div class="bg-gradient-to-r from-orange-400 via-amber-400 to-orange-300 p-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold text-white drop-shadow-lg">Edit Kontak</h2>
                        <p class="text-orange-50 mt-1 font-medium">Perbarui informasi kontak</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="4" required
                              class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-200 transition-all shadow-sm hover:shadow-md resize-none <?php echo isset($errors['address']) ? 'border-red-500' : ''; ?>"><?php echo htmlspecialchars($data['address']); ?></textarea>
